        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuidelineVersion = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RequireConsensus = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProjectId = table.Column<int>(type: "int", nullable: false),
                    FlagType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectFlags_Projects_ProjectId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignment_DataItem_Annotator",
                table: "Assignments",
                columns: new[] { "DataItemId", "AnnotatorId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectFlags_ProjectId1",
                table: "ProjectFlags",
                column: "ProjectId1");
